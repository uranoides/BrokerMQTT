...
using static MQTT.Utilities.Global;
...
namespace MQTT.Utilities
{
    public static class JsonManager
    {
        ...
        private static string JsonPathFile = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + @"\ConnectionSettings.json";
        private static string JsonBlebPayloadPathFile = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + @"\BlebPayload.json";
        public static async Task<ConnectionSettings> GetConnectionByIdAsync(int connectionId)
        {
        ...
        public static async Task<List<ConnectionSettings>> ReadJsonAsync()
        {
        ...
        public static async Task<string> LoadAndDeserializeFromResource()
        {
            try
            {
        ...
        public static async Task<SensorPayload> ReadJsonSensorPayloadAsync(string jsonString)
        {
        ...
        public static async Task SaveJsonAsync(List<ConnectionSettings> entries)
        {
        ...
        public static async Task UpdateAndSaveEntryAsync(int processIdToUpdate, ConnectionSettings newValue)
        {
